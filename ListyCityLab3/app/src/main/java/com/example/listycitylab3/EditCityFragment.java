...
public class EditCityFragment extends DialogFragment {
    ...
    private EditCityDialogListener listiner;
    private int pos;
    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        if (context instanceof EditCityDialogListener) {
            listiner = (EditCityDialogListener) context;
        } else {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        EditText city = view.findViewById(R.id.edit_city_name);
        EditText province = view.findViewById(R.id.edit_province_name);

        city.setText(getArguments().getString("city"));
        province.setText(getArguments().getString("province"));
        ...
        return builder
                ...
                .setPositiveButton("Save", (dialog, which) -> {
                    ...
                    listiner.editCity(new City(newCity, newProvince), pos);
                })
                .create();
