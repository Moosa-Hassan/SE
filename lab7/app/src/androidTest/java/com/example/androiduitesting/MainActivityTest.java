...
public class MainActivityTest {
    ...
    // Check if text "Edmonton" is matched with any of the tex
...
//        is(instanceOf(String.class))
    ...
    public void testCityNameConsistency() {
        ...
        // Check if ShowActivity displays the correct name
        onView(withId(R.id.cityNameText)).check(matches(withText("Lahore")));
    }
